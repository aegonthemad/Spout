...
public class CuboidBlockUpdateMessageHandler implements ClientMessageHandler<CuboidBlockUpdateMessage> {
	@Override
	public void handle(Session session, CuboidBlockUpdateMessage message) {

...
public class RemoveEntityMessageHandler implements ClientMessageHandler<RemoveEntityMessage> {
	@Override
	public void handle(Session session, RemoveEntityMessage message) {
